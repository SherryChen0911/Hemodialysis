			...
			<form @submit="resetTreatInfo">
				...
				<view v-show="segCtrlSelected === 0">
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space2">
							<radio-group name="has_special_state">
								<label  v-for="item in info.status" class="radio-item">
									<radio v-model="item.value" :checked="item.checked" color="#51D3C7"  style="transform:scale(0.7)" />
									{{item.name}}
								</label>					
							</radio-group>	
						</view>
						<view class="form-cnt form-mid-space" v-show="statusInput">
							<input class="form-mid-space" v-model="dialysisInfo.special_state" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="dialysisInfo.frequency_hours" type="text" placeholder=""/>
							<text>h</text>
						</view>
						<view class="form-cnt form-mid-space">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="dialysisInfo.clean_up_times" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space">
							<picker mode="selector" name="treatmentitems" :range="treatmentRange"  @change="setTreatment">
							<input class="form-mid-space" disabled="true" v-model="dialysisInfo.treatmentitems" type="text" placeholder=""/>
							</picker>
						</view>
					</view>
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							...
							<input class="form-mid-space" disabled="true" v-model="dialysisInfo.filter" type="text" placeholder=""/>
							</picker>
						</view>
					</view>
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space disable-style">
							<input class="form-mid-space" v-model="dialysisInfo.allvascularaccess" disabled="true" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="chuanci_dunzhen">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="chuanci_fangxiang">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="dialysisInfo.before_temperature" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space disable-style">
							<picker mode="selector" disabled="true" :range="bloodmethodRange"  @change="setBloodmethod">
								<input class="form-mid-space" disabled="true" v-model="antiFreeze" type="text" placeholder=""/>
							</picker>
						</view>
					</view>
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space disable-style">
							<input class="form-mid-space" disabled="true" v-model="dialysisInfo.first_drug_dosage" type="text" placeholder=""/>
							<picker  class="form-suffix-space" mode="selector" disabled="true" :range="drugunitRange"  @change="setDoseRange1">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space disable-style">
							<input class="form-mid-space" disabled="true" v-model="dialysisInfo.second_drug_dosage" type="text" placeholder=""/>
							<picker class="form-suffix-space" mode="selector" disabled="true" :range="drugunitRange"  @change="setDoseRange2">
				...
				<view v-show="segCtrlSelected === 1">
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_wound_allergy" @change="setTremor">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_plaster_allergy"  @change="setNoise">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_hongzhong" @change="setSwell">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_xiazhai" @change="setNarrow">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_liuyangkuozhang" @change="setExpand">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<checkbox-group name="huli" @change="setmedicare">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.actual_cleanup_hour" type="text" placeholder=""/>
							<text>h</text>
						</view>
						<view class="form-cnt form-mid-space">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.dry_weight" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.last_time_dry_weight" type="text" placeholder=""/>
						</view>
					</view>				
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.before_dry_weight" type="text" placeholder=""/>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="pcly" @change="setExpand">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.dry_weight_tag" type="text" placeholder=""/>
						</view>
					</view>	
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space">
							<input class="form-mid-space" v-model="treatStateInfo.dry_weight_add" type="text" placeholder=""/>
						</view>
					</view>	
					<view class="form-item">
						<view class="form-prefix-space">
					...
					<view class="form-item">
						...
						<view class="form-cnt form-mid-space" :class="{'disable-style' : nursePicker1}">
							<picker mode="selector" :disabled="nursePicker1" :range="nurseRange"  @change="setNurese1">
								<input class="form-mid-space" v-model="treatStateInfo.primary_nurse" disabled="true" type="text" placeholder=""/>
							</picker>
						</view>
						<view class="form-cnt-noborder form-mid-space">
					...
					<view class="form-item">
						...
						<view :class="nursePicker2 ? 'form-cnt form-mid-space disable-style' :'form-cnt form-mid-space'">
							<picker mode="selector" :disabled="nursePicker2" :range="nurseRange"  @change="setNurese2">
								<input class="form-mid-space" v-model="treatStateInfo.check_nurse" disabled="true" type="text" placeholder=""/>
							</picker>
						</view>
						<view class="form-cnt-noborder form-mid-space">
							<button :class="nursePicker2 ?'one-btn small-btn':'err-btn small-btn'" @click="ableNurse2">修改签名</button>
						</view>
					</view>
					<view class="form-item">
						<view class="form-prefix-space">
						...
						<view class="form-cnt form-mid-space" :class="{'disable-style' : nursePicker3}">
							<picker mode="selector" :disabled="nursePicker3" :range="nurseRange"  @change="setNurese3">
								<input class="form-mid-space" v-model="treatStateInfo.puncture_nurse" disabled="true" type="text" placeholder=""/>
							</picker>
						</view>
						<view class="form-cnt-noborder form-mid-space">
							<button :class="nursePicker3 ?'one-btn small-btn':'err-btn small-btn'" @click="ableNurse3">修改签名</button>
						</view>
					</view>	
	...
	export default {
		data() {
			return {
				...
				treatStateInfo:{},
				info:{
					status:[{name:'有', checked:false, value:'1'},{name:'无', checked:false, value:'0'},],
					puncture:[{name:'钝针', checked:false, value:'0'},{name:'锐针', checked:false, value:'1'}],
					...
					medicare:[{name:'无', checked:true, value:'wu'},{name:'热敷', checked:false, value:'refu'},{name:'喜疗妥', checked:false, value:'xiliaotuo'},{name:'硫酸镁', checked:false, value:'liusuanmei'},],
		...
		onLoad() {
			...
			// 			//获取核对护士名称
			// 			console.log("获取核对护士名称");
			// 			for (let i = 0; i < this.nurseInfo.length; i++) {
			// 				console.log("要找的那个护士",this.treatStateInfo.check_nurse);
			// 				console.log("核对护士id",this.nurseInfo[i].emp_no);
			// 				console.log("核对护士名称",this.nurseInfo[i].name);
			// 				console.log("序号",i);
			// 				if(this.nurseInfo[i].emp_no == this.treatStateInfo.check_nurse){
			// 					this.treatStateInfo.check_nurse = this.nurseInfo[i].name;
			// 					console.log("check_nurse",this.treatStateInfo.check_nurse);
			// 					break;
			// 				}
			// 			}
			// 		}
		...
		methods: {
			...
			toPatientList(){
				...
				this.info.status=[{name:'有', checked:false, value:'1'},{name:'无', checked:false, value:'0'},];
				this.info.puncture=[{name:'钝针', checked:false, value:'0'},{name:'锐针', checked:false, value:'1'}];
				this.info.direction=[{name:'向心', checked:false, value:'0'},{name:'离心', checked:false, value:'1'}];
				this.info.tremor=[{name:'强', checked:false, value:'0'},{name:'中', checked:false, value:'1'},{name:'弱', checked:false, value:'2'},{name:'无', checked:false, value:'3'},];
				this.info.noise=[{name:'强', checked:false, value:'0'},{name:'中', checked:false, value:'1'},{name:'弱', checked:false, value:'2'},{name:'无', checked:false, value:'3'},];
				this.info.swell=[{name:'有', checked:false, value:'0'},{name:'无',checked:false,value:'1'},];
				this.info.narrow=[{name:'有', checked:false, value:'0'},{name:'无', checked:false, value:'1'},];
				this.info.expand=[{name:'有', checked:false, value:'0'},{name:'无', checked:false, value:'1'},];
				this.info.medicare=[{name:'无', checked:true, value:'wu'},{name:'热敷', checked:false, value:'refu'},{name:'喜疗妥', checked:false, value:'xiliaotuo'},{name:'硫酸镁', checked:false, value:'liusuanmei'},];
				uni.navigateTo({
			...
			//选择变更：护理措施
			setmedicare(e){
				console.log("护理措施",e.detail.value);
			},
			//下拉框选择医生
			setDoctor(e){
				...
				console.log("选择医生id",this.pickerInfo.primary_doctor);
			},
			//责任护士修改按钮,解除禁用
			ableNurse1(){
			...
			setNurese1(e){
				...
				console.log("选择责任护士id",this.pickerInfo.primary_nurse);
			},
			//下拉框选择核对护士
			setNurese2(e){
				...
				console.log("选择核对护士id",this.pickerInfo.check_nurse);
			},
			//下拉框选择穿刺护士
			setNurese3(e){
				...
				console.log("选择穿刺护士id",this.pickerInfo.puncture_nurse);
			},
			//修改治疗信息
			resetTreatInfo(e){
				//获取治疗方式id
				...
				this.$myRequest({
					...
					data:{
						...
						"after_temperature":this.treatStateInfo.after_diastolic_pressure,
				...
				// console.log("cure_id",this.patient.cure_id);
				// console.log("has_special_state",e.detail.value.has_special_state);
				// console.log("special_state",this.dialysisInfo.special_state);
				// console.log("frequency_hours",this.dialysisInfo.frequency_hours);
				// console.log("frequency_minute",this.dialysisInfo.frequency_minute);
				// console.log("clean_up_times",this.dialysisInfo.clean_up_times);
				// console.log("treatmentitems",this.pickerInfo.treatmentitems);
				// console.log("filter",this.pickerInfo.filter);
				// console.log("chuanci_dunzhen",e.detail.value.chuanci_dunzhen);
				// console.log("chuanci_fangxiang",e.detail.value.chuanci_fangxiang);
				// console.log("before_temperature",this.dialysisInfo.before_temperature);
				// console.log("before_bp",this.dialysisInfo.before_bp);
				// console.log("br",this.dialysisInfo.br);
				// console.log("calcium_ion",this.dialysisInfo.calcium_ion);
				// console.log("bloow_flow",this.dialysisInfo.bloow_flow);
				// console.log("dialysate_flow",this.dialysisInfo.dialysate_flow);
				// console.log("in_basket_wound_allergy",e.detail.value.in_basket_wound_allergy);
				// console.log("in_basket_plaster_allergy",e.detail.value.in_basket_plaster_allergy);
				// console.log("in_basket_hongzhong",e.detail.value.in_basket_hongzhong);
				// console.log("in_basket_xiazhai",e.detail.value.in_basket_xiazhai);
				// console.log("in_basket_liuyangkuozhang",e.detail.value.in_basket_liuyangkuozhang);
				// console.log("in_basket_hulirefu",this.pickerInfo.in_basket_hulirefu);
				// console.log("in_basket_hulixiliaotuo",this.pickerInfo.in_basket_hulixiliaotuo);
				// console.log("in_basket_huliliusuanmei",this.pickerInfo.in_basket_huliliusuanmei);
				// console.log("actual_cleanup_hour",this.treatStateInfo.actual_cleanup_hour);
				// console.log("actual_cleanup_minute",this.treatStateInfo.actual_cleanup_minute);
				// console.log("dry_weight",this.treatStateInfo.dry_weight);
				// console.log("last_time_dry_weight",this.treatStateInfo.dry_weight);
				// console.log("before_dry_weight",this.treatStateInfo.before_dry_weight);
				// console.log("before_dry_weightpc",this.pickerInfo.before_dry_weightpc);
				// console.log("before_dry_weightly",this.pickerInfo.before_dry_weightly);
				// console.log("dry_weight_tag",this.treatStateInfo.dry_weight_tag);
				// console.log("dry_weight_add",this.treatStateInfo.dry_weight_add);
				// console.log("ufr",this.treatStateInfo.ufr);
				// console.log("after_dry_weight",this.treatStateInfo.after_dry_weight);
				// console.log("dry_water_value",this.treatStateInfo.dry_water_value);
				// console.log("hope_weight_lose",this.treatStateInfo.hope_weight_lose);
				// console.log("before_systolic_pressure",this.treatStateInfo.before_systolic_pressure);
				// console.log("before_diastolic_pressure",this.treatStateInfo.before_diastolic_pressure);
				// console.log("after_systolic_pressure",this.treatStateInfo.after_systolic_pressure);
				// console.log("after_diastolic_pressure",this.treatStateInfo.after_diastolic_pressure);
				// console.log("after_temperature",this.treatStateInfo.after_diastolic_pressure);
				// console.log("after_bp",this.treatStateInfo.after_bp);
				// console.log("afterbr",this.treatStateInfo.afterbr);
				// console.log("actualdisplacement_liquid",this.treatStateInfo.actualdisplacement_liquid);
				// console.log("coagulation_in_dialyser",e.detail.value.coagulation_in_dialyser);
				// console.log("primary_doctor",this.pickerInfo.primary_doctor);
				// console.log("primary_nurse",this.pickerInfo.primary_nurse);
				// console.log("check_nurse",this.pickerInfo.check_nurse);
				// console.log("puncture_nurse",this.pickerInfo.puncture_nurse);
			}
		}
	}
</script>
