...
<!-- 					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space2">
							<radio-group name="has_special_state1" @change="showStatusInput" v-if="hackReset">
...
<!-- 					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="chuanci_dunzhen1" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="chuanci_fangxiang1" v-if="hackReset">
				...
				<view v-show="segCtrlSelected === 1">
					...
					<!-- <view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_wound_allergy1" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_plaster_allergy1" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_hongzhong1" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_xiazhai1" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="in_basket_liuyangkuozhang1" v-if="hackReset">
...
<!-- 					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="coagulation_in_dialyser1" v-if="hackReset">
				...
				<view v-show="segCtrlSelected === 3">
					...
					<!-- <view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="ovascular_access_firm2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_access_shed2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<checkbox-group name="fuliao" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_access_swelling2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_access_errhyisis2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_access_shenye2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_access_thrombus2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<checkbox-group name="daoguanqingkuang" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_rongshuan2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_duijiefangshi2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_xueliuganran2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_kangshengsu2" v-if="hackReset">
					...
					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="vascular_xuanjiao2" v-if="hackReset">
...
<!-- 					<view class="form-item">
						...
						<view class="form-cnt-noborder form-mid-space">
							<radio-group name="coagulation_in_dialyser2" v-if="hackReset">
								<label v-for="item in info.cruor" class="radio-item">
									<radio v-model="item.value" :checked="item.checked" color="#51D3C7"
										style="transform:scale(0.7)" />
									{{item.name}}
	...
	export default {
		...
		onShow: function() {
			...
			try{
				...
				log.push("进入 searchInfo")
				//判断病人的类型：置管or内瘘
				this.patient = Store.getStorageSync("patient");
				console.log("patient:", this.patient);
				log.push("进入 patient")
				let tempType = this.patient.vascularaccess.indexOf("置管");
				//控制内瘘tab页
				if(tempType == -1){
					this.infoType = 0;
				...
				log.push("进入 患者类型")
				console.log("患者类型",this.infoType);
				//数据清理
				this.treatmentRange = [];
				this.fliterRange = [];
				...
				log.push("进入 获取透析信息数据")
				//判断类型获取治疗与评估状况数据
				if(this.infoType == 0){
					this.getTreatInfo();
					log.push("进入 获取治疗与评估状况数据1")
				}
				else if(this.infoType == 1){
					this.getTreatInfoZG();
					log.push("进入 获取治疗与评估状况数据2")
				}
				log.push("接口获取数据完成")
					this.a = "1111"
				this.$forceUpdate()
		...
		methods: {
			...
			resetTreatInfo(e) {
				...
				console.log("内瘘crueid:",this.dialysisInfo.cure_id)
				//治疗信息修改提交
				this.$myRequest({
			...
			resetTreatInfoZG(e){
				console.log("置管修改");
				console.log("e",e);
				console.log("cureid:",this.patient.cure_id);
				console.log("recipeid:",this.patient.recipe_id);
				//获取治疗方式id
				if (this.pickerInfo.treatmentitems == "") {
					for (let i = 0; i < this.treatmentInfo.length; i++) {
						if (this.treatmentInfo[i].item_name == this.dialysisInfo.treatmentitems) {
				...
				// console.log(this.info.dressing);
				// this.treatStateInfo.fuliao_ganzhaowanhao = "";
				// this.treatStateInfo.fuliao_bujinmi = "";
				// this.treatStateInfo.fuliao_queshi = "";
				// for (let i = 0; i < e.detail.value.fuliao.length; i++) {
				// 	if(e.detail.value.fuliao[i] == ""){
				// 		this.treatStateInfo.fuliao_ganzhaowanhao = "1";
				// 	}
				// 	else if(e.detail.value.fuliao[i] == "1"){
				// 		this.treatStateInfo.fuliao_bujinmi = "1";
				// 	}
				// 	else if(e.detail.value.fuliao[i] == "2"){
				// 		this.treatStateInfo.fuliao_queshi = "1";
				// 	}
				// }
				// console.log("敷料1",this.treatStateInfo.fuliao_ganzhaowanhao);
				// console.log("敷料2",this.treatStateInfo.fuliao_bujinmi);
				// console.log("敷料3",this.treatStateInfo.fuliao_queshi);
				// this.treatStateInfo.vascular_access_smooth = "0";
				// this.treatStateInfo.vascular_access_dmkunnan = "0";
				// this.treatStateInfo.vascular_access_jmkunnan = "0";
				// for (let i = 0; i < e.detail.value.daoguanqingkuang.length; i++) {
				// 	if(e.detail.value.daoguanqingkuang[i] == "0"){
				// 		this.treatStateInfo.vascular_access_smooth = "1";
				// 	}
				// 	else if(e.detail.value.daoguanqingkuang[i] == "1"){
				// 		this.treatStateInfo.vascular_access_dmkunnan = "1";
				// 	}
				// 	else if(e.detail.value.daoguanqingkuang[i] == "2"){
				// 		this.treatStateInfo.vascular_access_jmkunnan = "1";
				// 	}
				// }
				// console.log("置管1",this.treatStateInfo.vascular_access_smooth);
				// console.log("置管2",this.treatStateInfo.vascular_access_dmkunnan);
				// console.log("置管3",this.treatStateInfo.vascular_access_jmkunnan);
				//获取透析器凝血状态值
				if(this.cruor1 == true){
					this.treatStateInfo.coagulation_in_dialyser = "0";
				}
				...
				console.log("crueid:",this.dialysisInfo.cure_id)
				this.$myRequest({
			...
			getTreatInfo(){
				...
				this.$myRequest({
					...
					success: (res) => {
						if (res.data.code == 200) {
							this.title2 = "内瘘病人评估与治疗情况";
							this.rizhi2 = res.data.data;
							...
							// for (let i = 0; i < this.info.cruor.length; i++) {
			...
			getTreatInfoZG(){
				...
				this.$myRequest({
					...
					success: (res) => {
						if (res.data.code == 200) {
							this.title3 = "置管病人评估与治疗情况";
							this.rizhi3 = res.data.data;
							console.log("置管病人评估与治疗情况:", res.data.data);
							this.treatStateInfo = _.cloneDeep(res.data.data);
							//页面加载信息：固定牢固
							...
							// for (let i = 0; i < this.info.fixed.length; i++) {
							// 	if (this.info.fixed[i].value == this.treatStateInfo.ovascular_access_firm) {
							// 		this.info.fixed[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.slide.length; i++) {
							// 	if (this.info.slide[i].value == this.treatStateInfo.vascular_access_shed) {
							// 		this.info.slide[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.pipeSwell.length; i++) {
							// 	if (this.info.pipeSwell[i].value == this.treatStateInfo.vascular_access_swelling) {
							// 		this.info.pipeSwell[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.bleedBlood.length; i++) {
							// 	if (this.info.bleedBlood[i].value == this.treatStateInfo.vascular_access_errhyisis) {
							// 		this.info.bleedBlood[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.bleedLiquid.length; i++) {
							// 	if (this.info.bleedLiquid[i].value == this.treatStateInfo.vascular_access_shenye) {
							// 		this.info.bleedLiquid[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.thrombus.length; i++) {
							// 	if (this.info.thrombus[i].value == this.treatStateInfo.vascular_access_thrombus) {
							// 		this.info.thrombus[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.thrombolysis.length; i++) {
							// 	if (this.info.thrombolysis[i].value == this.treatStateInfo.vascular_rongshuan) {
							// 		this.info.thrombolysis[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.joinWay.length; i++) {
							// 	if (this.info.joinWay[i].value == this.treatStateInfo.vascular_duijiefangshi) {
							// 		this.info.joinWay[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.bleedInfection.length; i++) {
							// 	if (this.info.bleedInfection[i].value == this.treatStateInfo.vascular_xueliuganran) {
							// 		this.info.bleedInfection[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.antibiotic.length; i++) {
							// 	if (this.info.antibiotic[i].value == this.treatStateInfo.vascular_kangshengsu) {
							// 		this.info.antibiotic[i].checked = true;
							// 		break;
							// 	}
							// }
							// for (let i = 0; i < this.info.guide.length; i++) {
							// 	if (this.info.guide[i].value == this.treatStateInfo.vascular_xuanjiao) {
							// 		this.info.guide[i].checked = true;
							// 		break;
							// 	}
							// }
							// if(this.treatStateInfo.fuliao_ganzhaowanhao == "1"){
							// 	this.info.dressing[0].checked = true;
							// }
							// if(this.treatStateInfo.fuliao_bujinmi == "1"){
							// 	this.info.dressing[1].checked = true;
							// }
							// if(this.treatStateInfo.fuliao_queshi == "1"){
							// 	this.info.dressing[2].checked = true;
							// }
							// if(this.treatStateInfo.vascular_access_smooth == "1"){
							// 	this.info.pipeStatus[0].checked = true;
							// }
							// if(this.treatStateInfo.vascular_access_dmkunnan == "1"){
							// 	this.info.pipeStatus[1].checked = true;
							// }
							// if(this.treatStateInfo.vascular_access_jmkunnan == "1"){
							// 	this.info.pipeStatus[2].checked = true;
							// }
							//页面加载信息：平车/轮椅
							if (this.treatStateInfo.before_dry_weightpc == "1") {
								console.log("enter pc");
